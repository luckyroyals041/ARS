...
def generate_student_sql(students):
    ...
    for student in students:
        ...
        sql = f"INSERT INTO students (name, registration_number, branch, current_semester, address) " \
...
def generate_course_sql(courses):
    ...
    for course in courses:
        ...
        sql = f"INSERT INTO courses (name, code, credits, semester, department) " \
              f"VALUES ({', '.join(values)});"
        sql_statements.append(sql)
...
def generate_grade_sql(grades):
    ...
    for grade in grades:
        ...
        sql = f"INSERT INTO grades (registration_number, course_code, grade, grade_points, " \
