...
def generate_html(student, records, summaries=None, includeCharts=False):
...
def generate_pdf_report(selected_student, includeCharts=False):
    ...
    html_content = generate_html(student, records, summaries, includeCharts)
