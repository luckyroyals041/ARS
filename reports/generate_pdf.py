...
# def generate_individual_pdf_report(selected_students=None):
#     """Generates PDF reports for selected students dynamically."""
...
# def generate_individual_pdf_report(selected_students):
#     """Generates PDF reports for selected students and returns path to a ZIP file."""
#     if not selected_students:
#         print("⚠️ Please select at least one student by registration number or name.")
#         return None
...
#             # Clean up individual PDF (optional)
#             os.remove(pdf_output_path)
...
# def generate_combined_pdf_report(selected_students):
#     """Generates individual PDFs and merges them into a single combined PDF."""
    
#     # Fetch data and validate
#     students, records = fetch_filtered_student_data(selected_students)
#     if students is None or not students:
#         print("⚠️ No data found for selected students.")
#         return None
...
#     for student in students:
#         html_content = generate_html(student, records)
#         temp_html_file = f"temp_{student['registered_no']}.html"
#         temp_pdf_file = f"{student['registered_no']}.pdf"
...
#     combined_path = os.path.join(tempfile.gettempdir(), "Combined_Student_Report.pdf")
#     merger.write(combined_path)
#     merger.close()
